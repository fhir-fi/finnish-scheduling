Profile: FinnishSchedulingHealthcareService
Parent: HealthcareService
Id: FinnishSchedulingHealthcareService
Description: "Finnish profile for healthcare service."
* ^url = "http://hl7.fi/fhir/StructureDefinition/FinnishSchedulingHealthcareService"
* ^status = #draft
* category ..1
