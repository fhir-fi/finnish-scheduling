Profile: FinnishSchedulingAppointment
Parent: Appointment
Id: FinnishSchedulingAppointment
...
* ^url = "http://hl7.fi/fhir/StructureDefinition/FinnishSchedulingAppointment"
* ^status = #draft
