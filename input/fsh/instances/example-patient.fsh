...
* extension.url = "http://hl7.fi/fhir/StructureDefinition/HomeMunicipalityExtension"
...
* name.family = "Potilas"
* name.given = "Pentti"
* contact.relationship = urn:oid:1.2.246.537.6.882#1 "Huoltaja"
* contact.name.family = "Potilas"
